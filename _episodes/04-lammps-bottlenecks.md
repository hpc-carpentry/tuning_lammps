...
The following table shows the timing breakup when the number of partcles is about 10M which is quite large! Note that, though the absolute time to complete the simulation has increased significantly, the distribution of *%total%* remains same.
